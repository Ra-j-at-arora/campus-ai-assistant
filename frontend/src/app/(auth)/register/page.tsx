  ...
  return (
    <div className="space-y-6">
      ...
      <form onSubmit={handleSubmit(onSubmit)} className="space-y-5">
        <div>
          <label className="block text-sm font-medium text-[#111827] dark:text-slate-200 mb-1">Full Name</label>
          <input
            {...register('name')}
      ...
      <p className="text-center text-sm text-[#6B7280] dark:text-slate-400 mt-6 transition-colors">
        ...
        <Link href="/login" className="font-medium text-[#4F46E5] dark:text-indigo-400 hover:text-indigo-600 dark:hover:text-indigo-300 hover:underline">
          Sign in
        </Link>
      </p>
    </div>
